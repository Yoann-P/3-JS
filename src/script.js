...
const doorAlphaTextutre = textureLoader.load("textures/door/alpha.jpg");
...
walls.position.y = 2.5 / 2; // hauteur (y) diviser par 2
house.add(walls);
...
roof.position.y = 2.5 + 0.5; // hauteur du mur (walls) + hauteur roof (y) diviser par 2
...
door.position.y = 1;
door.position.z = 2 + 0.01; // profondeur de walls (z) diviser par 2 (4:2) + 0.01(eviter le Z effect)
